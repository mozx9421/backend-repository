        ...
        <div class="row justify-content-center">
          <div class="col-lg-5 col-md-4">
            ...
            <div class="form-group mb-3">
              <label class="input-group text-default">รหัสบัตรประชาชน</label>
              <div class="input-group input-group-merge input-group-alternative">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="ni ni-badge"></i></span>
                </div>
                <input type="text" name="emp_idcardnum" class="form-control"  placeholder="citizen id card" require>
              </div>
            </div>

            <div class="form-group">
              <label class="input-group text-default">เบอร์โทรศัพท์มือถือ</label>
              <div class="input-group input-group-merge input-group-alternative">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
                </div>
                <input type="text" name="emp_tel" class="form-control" placeholder="mobile number" require>
              </div>
            </div>

            <div class="text-center">
              <button type="submit" name="submit" class="btn btn-danger my-4" >ยืนยัน</button>
            </div>
          </div>
        </div>
      </div>
