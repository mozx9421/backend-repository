                ...
                <div class="table-responsive table-white table-striped animate-right">
                  <table class="table align-items-center table-flush ">
                    <tr class="thead-light" align="center">
                      ...
                      <th><h6 class="text-gray text-ml mb-0">จำนวนชิ้นต่อแพ็ค</h6></th>
                    ...
                    <tr align="center">
                      ...
                      <?php } else { ?>
                          ...
                          <td align="center">
                            <!-- Update Button -->
                            <button type="button" class="btn btn-outline-primary btn-sm text-black" data-toggle="modal" data-target="#unit_update_modal<?php echo $fetch['unit_id'] ?>">
