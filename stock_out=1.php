                            ...
                            <div class="row align-items-center">
                                <div class="table-responsive">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="stock_out.php"><i class="fas fa-file-export"></i> เบิกสินค้า</a>
                                        </li>
                                        <?php
                                        if ($_SESSION['emp_level'] == "ผู้จัดการ") {
                                            echo
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('#add').click(function() {
                                                ...
                                                html_code += "<td align=center><button type='button' name='remove' data-row='row" + count + "' class='btn btn-outline-danger btn-xs remove'><i class='fas fa-minus'></button></td>";
                                                html_code += "</tr>";
                                            ...
                                            $('#save').click(function() {
                                                ...
                                                var data = []
                                                var stock_status = 'เบิกออกสินค้า'
