<div class="modal fade" id="see_all_in" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLabel">TOP รับเข้าสินค้า</h2>
      ...
      <div class="modal-body">
        ...
        <table class="table-striped col-xl-10 center" border="1">
          <tr class="thead-light">
            ...
            <th><h6 class="mb-0" align="center">จำนวนที่รับเข้า</h6></th>
          </tr>
          <?php
            include('connect.php');
