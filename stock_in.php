        ...
        <div class="col-xl-10">
              ...
              <div class="row align-items-center">
                ...
                <div class="table-responsive">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active"><i class="fas fa-file-import"></i> รับเข้าสินค้า</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <table class="table-white col-xl-12 animate-left">
                    <tr>
                      ...
                      <td align="right">
                        <div class="col-xl-12">
                          <a href="stock_in=1.php">
                            <button type="button" class="btn btn-outline-primary"><i class="fas fa-plus"></i> เพิ่มรายการ</button>
                          </a>
                        </div>
                      </td>
                    </tr>
                ...
                <div class="table-responsive table-white table-striped animate-right">
                  <table class="table align-items-center table-flush">
                    ...
                    $query ="SELECT * FROM product JOIN stock JOIN emp_data
                      WHERE stock.emp_id = emp_data.emp_id
                      AND stock.product_id = product.product_id
                      AND stock.stock_id LIKE 'R%'
                      GROUP BY stock_id
                    ...
                    ?>
                      ...
                      <td><?php $start++; echo $start ?></td>
                        ...
                        <td>
                          <a href="stock_in_detail.php?stock_id=<?php echo $fetch['stock_id'] ?>">
          ...
          <nav aria-label="Page navigation example mb-4">
                <div class="container-fluid mt--2">
                  <ul class="pagination">
                  <li class="page-item">
                  <a class="page-link" href="stock_in.php?page=1" aria-label="Frist">
                  <span class="fas fa-angle-double-left"></span>
                    <span class="sr-only">Frist</span>
                  </a>
                </li>
                    <li class="page-item">
                      <a class="page-link" href="stock_in.php?page=<?= $previous_page; ?>" aria-label="Previous">
                      <span class="fas fa-angle-left"></span>
                        <span class="sr-only">Previous</span>
                      </a>
                    </li>
                    <?php for ($it = 1; $it <= $total_page; $it++) { ?>
                      <li class="page-item"><a class="page-link" href="stock_in.php?page=<?php echo $it; ?>"><?php echo $it; ?></a></li>
                    <?php } ?>
                    <li class="page-item">
                      <a class="page-link" href="stock_in.php?page=<?= $next_page; ?>" aria-label="Next">
                      <span class="fas fa-angle-right"></span>
                        <span class="sr-only">Next</span>
                      </a>
                    </li>
                    <li class="page-item">
                  <a class="page-link" href="stock_in.php?page=<?php echo $total_page; ?>" aria-label="Last">
