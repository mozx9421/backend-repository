              ...
              <div class="row align-items-center">
                ...
                <div class="table-responsive">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active"><i class="fas fa-adjust"></i> หมวดหมู่</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <table class="table-white col-xl-12 animate-left">
                    <tr>
                      ...
                      <td align="right">
                        <div class="col-xl-12">
                          <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#category_add_modal">
                ...
                <div class="table-responsive table-white table-striped animate-right">
                  <table class="table align-items-center table-flush">
                    ...
                    <?php
                      require 'connect.php';
                      $query = mysqli_query($conn, "SELECT * FROM category ORDER BY ctg_id ASC") or die(mysqli_error());
                      $x = 1;
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">เพิ่มหมวดหมู่</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form method="post" action="category.php" class="was-validated">
              <?php require('runid.php'); ?>
              <?php require('category_duplicate_name.php'); ?>
              <table class="col-xl-9 center">
                <tr>
                  <td align="right">รหัสหมวดหมู่ : &nbsp</td>
                  <td>
                    <input type="text" name="ctg_id" value="<?php echo $ctg_id; ?>" class="form-control" disabled='disabled'>
                    <input type="hidden" name="ctg_id" value="<?php echo $ctg_id; ?>" />
                  </td>
                </tr>
                <tr>
                  <td align="right">ชื่อหมวดหมู่ : &nbsp</td>
                  <td><input type="text" name="ctg_name" class="form-control" required></td>
                </tr>
              </table><br>
              <center>
