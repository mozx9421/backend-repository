            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <form action="TCPDF-master/examples/report_stock_out.php" method="POST">
                  ...
                  ตัวเลือกวันที่ :  <br>
                <input type="radio" name="choose" value='yes'> ระหว่างวัน </option>
                <input type="radio" name="choose" value='no'> วันที่เดียว </option>
                <br>
                    <div class="row">
                      <div class="col-md-5 ml-4 mt-2 mb-4" id="fromDate">
                        <label>วันที่</label>
                        <input type="date" name="from_date" value="<?php if (isset($_POST['from_date'])) {
                                                                      echo $_POST['from_date'];
                                                                    } ?>" class="form-control">
                      </div>
                      <div class="col-md-5 ml-5 mt-2 mb-4" id="toDate">
                      ...
                      <div class="col-md-5 ml-4 mt-2 mb-4">
                        <label>สินค้า</label>
