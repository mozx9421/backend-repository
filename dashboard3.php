                  ...
                  <div class="card-header bg-transparent ">
                    <div class="row align-items-center">
                      <div class="col">
                        ...
                        <h4 class="card-title text-uppercase mb-0">จำนวนการเคลมของสินค้าแต่ละตัว(แพ็ค) ภายใน 30 วัน</h4>
                        <div class="" align="right">
                          ...
                          <i style="color:rgba(204, 0, 0)"><i class="fas fa-square"></i></i> <u>เคลม</u>
                        </div>
                      </div>
                    </div>
                  </div>
