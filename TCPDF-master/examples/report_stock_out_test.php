...
$query = "SELECT * FROM stock JOIN product JOIN emp_data
  WHERE stock.product_id=product.product_id AND stock.emp_id=emp_data.emp_id ORDER BY stock_id DESC";
...
<thead>
 <tr style="background-color:#FFFF00;color:#0000FF;">
  ...
  <td width="140" align="center"><b>first</b></td>
 ...
 <tr>
  ...
  <td width="140" rowspan="6">Name<br />Name2<br />Name3<br />Name4<br />Name5<br />Name6<br />Name7<br />XXXX</td>
